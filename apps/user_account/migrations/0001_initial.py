    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('A', 'Quản trị viên'), ('M', 'Quản lý'), ('L', 'Người cho thuê'), ('R', 'Người thuê')], editable=False, max_length=1)),
                ...
                ('workplace_commune', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='working_renters', to='address.commune')),
            ],
            options={
                'verbose_name': 'user',
